...
interface GetLastNameStepProps {
    data_columns: string[],
    setLastNameCallback: (value: number) => void;
    disableButtonCallback: () => void;
}

const GetLastNameStep = ({data_columns, setLastNameCallback, disableButtonCallback}: GetLastNameStepProps) => {
...
export default GetLastNameStep;